...
var CButton = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(CLink.CLink, tslib_es6.__assign({ as: rest.href ? 'a' : as }, (!rest.href && { type: type }), { className: index.default('btn', variant ? "btn-".concat(variant, "-").concat(color) : "btn-".concat(color), (_b = {}, _b["btn-".concat(size)] = size, _b), shape, className) }, rest, { ref: ref }), children));
});
CButton.propTypes = {
