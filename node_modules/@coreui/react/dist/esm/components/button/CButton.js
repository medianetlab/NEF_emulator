...
var CButton = forwardRef(function (_a, ref) {
    ...
    return (React.createElement(CLink, __assign({ as: rest.href ? 'a' : as }, (!rest.href && { type: type }), { className: classNames('btn', variant ? "btn-".concat(variant, "-").concat(color) : "btn-".concat(color), (_b = {}, _b["btn-".concat(size)] = size, _b), shape, className) }, rest, { ref: ref }), children));
});
CButton.propTypes = {
