...
function ui_show_edit_cell_modal( cell_id ) {
    ...
    ui_draw_paths_to_map( edit_cell_map, edit_cell_path_lg, 0.4 );
}
...
function ui_show_add_cell_modal(  ) {
    ...
    ui_draw_paths_to_map( add_cell_map, add_cell_path_lg, 0.4 );
}
...
function ui_initialize_edit_cell_map() {
    ...
    edit_cell_map = L.map('edit_cell_mapid', {
        layers: [osm, edit_cell_lg, edit_cell_coverage_lg, edit_cell_UE_position_lg, edit_cell_path_lg]
...
function ui_initialize_add_cell_map() {
    ...
    add_cell_map = L.map('add_cell_mapid', {
        layers: [osm, add_cell_lg, add_cell_coverage_lg, add_cell_UE_position_lg, add_cell_path_lg]
    }).setView([48.499998, 23.383331], 5);    // Geographical midpoint of Europe
